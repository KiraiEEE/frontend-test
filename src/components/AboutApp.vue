<template>
  <div class="about-us-section p-6">
    ...
    <p class="text-lg text-gray-700 mt-4">
      Our team, led by developer Akram Ben Fekih, has worked tirelessly to ensure that this app not only meets but exceeds 
      the expectations of our users. We are excited about the possibilities it opens up and the potential it has to transform 
      daily operations.
    </p>
    <p class="text-lg text-gray-700 mt-4">
